...
def main():
    ...
    smtp_port = 587
    smtp_username = "wesleyarmstrong2020@unlock.web.id"
    smtp_password = "afgjkizfczkcblno"

    
    imap_server = "imap.gmail.com"
    imap_username = "wesleyarmstrong2020@unlock.web.id"
    imap_password = "afgjkizfczkcblno"
    imap_username_from_client = "tialivingston2020@unlock.web.id"
